...
<section class="mission_vision">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <img src="{{ asset('upload/Vission_images/'.$vission->image) }}" style=" width:30%; height:80%; border: 1px solid #ddd;padding: 5px;background: #EFEE03;border-radius: 30px;float: left;margin-right: 10px;">
