          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3>
                  Add Services
                  <a class=" float-right btn btn-success btn-sm" href="{{ route('services.view') }}"><i class="fa fa-plus-circle"></i>Services List</a>
                </h3>
              </div>
              <div class="card-body">
                <form method="post" action="{{ route('services.update',$editdata->id) }}" id="myform" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="long_title" id="long_title" class="form-control" rows="5">{{ $editdata->long_title }}</textarea>
