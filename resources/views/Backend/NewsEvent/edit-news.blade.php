          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3>
                  Update NewsEvent
                  <a class=" float-right btn btn-success btn-sm" href="{{ route('newsevent.view') }}"><i class="fa fa-plus-circle"></i>NewsEvent List</a>
                </h3>
              </div>
              <div class="card-body">
                <form method="post" action="{{ route('newsevent.update',$editdata->id) }}" id="myform" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="date" class="form-control"  id="datepicker" value="{{ $editdata->date }}" readonly>
                        ...
                        <div class="form-group col-md-2">
                            <img id="showImage"  src="{{ (!empty($editdata->image))?url('upload/News_images/'.$editdata->image):url('upload/noImage.jpg') }}" alt="" style="width:150px; height:160px;border:1px solid black">
                        </div>
